...
聊天侧栏的“扫雷”提供群聊发言、催进度、请假、工作汇报和拒绝加班五类场景。每个场景包含六项可逐格揭示的沟通风险，给出风险等级、踩雷原因、处理建议和可复制的稳妥表达，并可生成精简排雷报告分享到当前聊天室。

### 每日鱼塘

首页“每日鱼塘”每天轮换一道职场扫雷判断题、一个低负担微任务和一次匿名立场投票。浏览器本地记录当天完成进度与连续参与天数；投票由后端按日期统计，只保存匿名浏览器标识的哈希和选项，不关联账户身份。今日话题可一键带入闲聊大厅。
